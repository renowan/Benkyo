...
public:
    ...
    CCString *getCCStringValue() const {return CCString::createWithFormat("%d",m_nValue);}
    const char *getCStringValue() const {return CCString::createWithFormat("%d",m_nValue)->getCString();}
